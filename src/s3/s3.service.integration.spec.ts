...
describe('S3Service Integration Test', () => {
  ...
  describe('uploadAvatar', () => {
    it('should upload a real JPEG file to R2', async () => {
      ...
      const result = await service.uploadAvatar(testUserId, mockFile);

      console.log('Upload result:', result);
      expect(result).toBeDefined();
      expect(result).toContain('avatars/');
      expect(result).toContain('.jpeg');
      expect(result).toContain('r2.dev');
    }, 10000);

    it('should upload a real PNG file to R2', async () => {
